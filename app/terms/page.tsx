  ...
  return (
    <div style={{ background: 'var(--cream)', color: 'var(--dark)', minHeight: '100vh', padding: '6rem 1.5rem 4rem' }}>
      <div className="container" style={{ maxWidth: 800, background: 'var(--white)', padding: '3rem', borderRadius: 24, boxShadow: '0 8px 32px rgba(0,0,0,0.1)', border: '1px solid var(--gray-light)' }}>
        ...
        <h1 style={{ fontFamily: "'Poppins', sans-serif", fontSize: '2.5rem', fontWeight: 800, color: 'white', marginBottom: '2rem', textAlign: 'center' }}>
          Terms & Conditions
        </h1>
        ...
        <div style={{ color: 'var(--dark)', lineHeight: 1.8, fontSize: '0.95rem' }}>
          ...
          <h2 style={{ fontSize: '1.25rem', color: 'white', marginTop: '2rem', marginBottom: '1rem', fontFamily: "'Poppins', sans-serif" }}>1. Booking & Confirmation</h2>
          ...
          <h2 style={{ fontSize: '1.25rem', color: 'white', marginTop: '2rem', marginBottom: '1rem', fontFamily: "'Poppins', sans-serif" }}>2. Payment Policy</h2>
          <ul style={{ listStyle: 'disc', paddingLeft: '1.5rem', marginBottom: '1.5rem' }}>
          ...
          <h2 style={{ fontSize: '1.25rem', color: 'white', marginTop: '2rem', marginBottom: '1rem', fontFamily: "'Poppins', sans-serif" }}>3. Cancellation & Refund Policy</h2>
          <ul style={{ listStyle: 'disc', paddingLeft: '1.5rem', marginBottom: '1.5rem' }}>
          ...
          <h2 style={{ fontSize: '1.25rem', color: 'white', marginTop: '2rem', marginBottom: '1rem', fontFamily: "'Poppins', sans-serif" }}>4. Trip Cancellation</h2>
          ...
          <h2 style={{ fontSize: '1.25rem', color: 'white', marginTop: '2rem', marginBottom: '1rem', fontFamily: "'Poppins', sans-serif" }}>5. Itinerary Changes</h2>
          ...
          <h2 style={{ fontSize: '1.25rem', color: 'white', marginTop: '2rem', marginBottom: '1rem', fontFamily: "'Poppins', sans-serif" }}>6. Participant Responsibility</h2>
          <ul style={{ listStyle: 'disc', paddingLeft: '1.5rem', marginBottom: '1.5rem' }}>
          ...
          <h2 style={{ fontSize: '1.25rem', color: 'white', marginTop: '2rem', marginBottom: '1rem', fontFamily: "'Poppins', sans-serif" }}>7. Health & Fitness</h2>
          ...
          <h2 style={{ fontSize: '1.25rem', color: 'white', marginTop: '2rem', marginBottom: '1rem', fontFamily: "'Poppins', sans-serif" }}>8. Safety & Liability</h2>
          ...
          <h2 style={{ fontSize: '1.25rem', color: 'white', marginTop: '2rem', marginBottom: '1rem', fontFamily: "'Poppins', sans-serif" }}>9. Women's Safety</h2>
          ...
          <h2 style={{ fontSize: '1.25rem', color: 'white', marginTop: '2rem', marginBottom: '1rem', fontFamily: "'Poppins', sans-serif" }}>10. Code of Conduct</h2>
          ...
          <h2 style={{ fontSize: '1.25rem', color: 'white', marginTop: '2rem', marginBottom: '1rem', fontFamily: "'Poppins', sans-serif" }}>11. Alcohol & Smoking</h2>
          ...
          <h2 style={{ fontSize: '1.25rem', color: 'white', marginTop: '2rem', marginBottom: '1rem', fontFamily: "'Poppins', sans-serif" }}>12. Photography</h2>
          ...
          <h2 style={{ fontSize: '1.25rem', color: 'white', marginTop: '2rem', marginBottom: '1rem', fontFamily: "'Poppins', sans-serif" }}>13. Personal Belongings</h2>
          ...
          <h2 style={{ fontSize: '1.25rem', color: 'white', marginTop: '2rem', marginBottom: '1rem', fontFamily: "'Poppins', sans-serif" }}>14. Transportation</h2>
          ...
          <h2 style={{ fontSize: '1.25rem', color: 'white', marginTop: '2rem', marginBottom: '1rem', fontFamily: "'Poppins', sans-serif" }}>15. Meals & Accommodation</h2>
          ...
          <h2 style={{ fontSize: '1.25rem', color: 'white', marginTop: '2rem', marginBottom: '1rem', fontFamily: "'Poppins', sans-serif" }}>16. Environmental Responsibility</h2>
          ...
          <h2 style={{ fontSize: '1.25rem', color: 'white', marginTop: '2rem', marginBottom: '1rem', fontFamily: "'Poppins', sans-serif" }}>17. Emergency Contact</h2>
          <p style={{ marginBottom: '1.5rem' }}>Every participant must provide a valid emergency contact number before the trip.</p>

          <h2 style={{ fontSize: '1.25rem', color: 'white', marginTop: '2rem', marginBottom: '1rem', fontFamily: "'Poppins', sans-serif" }}>18. Minimum Group Size</h2>
          ...
          <h2 style={{ fontSize: '1.25rem', color: 'white', marginTop: '2rem', marginBottom: '1rem', fontFamily: "'Poppins', sans-serif" }}>19. Travel Insurance</h2>
          ...
          <h2 style={{ fontSize: '1.25rem', color: 'white', marginTop: '2rem', marginBottom: '1rem', fontFamily: "'Poppins', sans-serif" }}>20. Force Majeure</h2>
          ...
          <h2 style={{ fontSize: '1.25rem', color: 'white', marginTop: '2rem', marginBottom: '1rem', fontFamily: "'Poppins', sans-serif" }}>21. Acceptance of Terms</h2>
